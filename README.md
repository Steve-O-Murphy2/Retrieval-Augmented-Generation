...
- [Documentation Considerations](project-docs/documentation-considerations.md)--if you want to see how to write technical documentation for optimized RAG consumption
